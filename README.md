# php-base - PHP Slim 4 Server library for Decision Tree API
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **decisionsGet** | **GET** /decisions | Report decisions
*AbstractDefaultApi* | **decisionsPost** | **POST** /decisions | Save a decision


## Models

* OpenAPIServer\Model\Decision
